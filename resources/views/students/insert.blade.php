...
<body class="bg-slate-300">
    ...
    <div class="flex items-center mt-5 max-w-md mx-auto rounded-md bg-white shadow-lg">
        <div class="w-full bg-white rounded shadow-lg p-8 m-4">
            <h1 class="block w-full text-center font-bold tracking-widest uppercase text-blue-600 mb-6">Add Student</h1>
            <form class="mb-4" method="POST" action="{{ url('insert') }}">
                @csrf
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="name">Student Name</label>
                    <input class="border border-gray-900 rounded-sm py-2 px-3 text-gray-800" type="text" name="name" id="name">
                </div>
                <div class="flex flex-col mb-4">
                    <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="first_name">Student Address</label>
                    <input class="border border-gray-900 rounded-sm py-2 px-3 text-gray-800" type="text" name="address" id="address">
                </div>
                <button class="block bg-blue-900 text-white hover:bg-red-700 uppercase font-bold text-lg mx-auto p-4 rounded" type="submit">Register Student</button>
            </form>
            <a class="block w-full text-center  text-sm text-grey-dark hover:text-grey-darker underline"
